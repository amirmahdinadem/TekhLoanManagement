    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FundMember", x => new { x.FundsId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_FundMember_Funds_FundsId",
                        column: x => x.FundsId,
                        principalTable: "Funds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FundMember_Members_MembersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FundMember_MembersId",
                table: "FundMember",
                column: "MembersId");

            migrationBuilder.CreateIndex(
                name: "IX_Funds_WalletAccountId",
                table: "Funds",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CreditWalletAccountId",
                table: "Transactions",
                column: "CreditWalletAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_DebitWalletAccountId",
                table: "Transactions",
                column: "DebitWalletAccountId");
        }
